...
> للأنماط التصميمية المعتمدة (الإجراء الأساسي الواحد، شريط المرحلة، الحالات الفارغة
> الموجّهة، إتاحة الوصول، مصدر الحقيقة الواحد…) راجع **[DESIGN.md](../DESIGN.md)** —
> وهو مرجع ملزِم لأي إضافة قادمة، ويفحصه `test_design_language.js` ليبقى مطابقًا للكود.
