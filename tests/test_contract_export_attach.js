...
const wait=setInterval(()=>{
  ...
  const extra=[
    ...
    ['زر التصدير متاح لكل أنواع العقود (لا القياسي فقط)',
      hub.includes('📄 تصدير PDF (بالملاحق)')&&!hub.includes("!isCustom?'<button class=\"reqbtn\" id=\"chdExport\"")],
    ['زر تكرار العقد موجود',hub.includes('id="chdDuplicate"')],
