...
js_files=['src/config.js','src/engine.js','src/api.js','src/views.js','src/app.js','src/dol.js','src/importer.js']
...
html=re.sub(r'\n<script src="(config|engine|api|views|app|dol|importer)\.js"></script>','',html)
